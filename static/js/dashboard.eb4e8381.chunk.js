"use strict";(globalThis.webpackChunkmavis_ai_web||=[]).push([[945],{7875(e,t,n){n.r(t),n.d(t,{default:()=>lt});var o=n(5043),r=n(4138),a=n(7246),i=n(4960),s=n(7149),d=n(1009),l=n(579);const c=e=>{let{selectedTag:t,selectedDate:n,searchContent:o,onSearchChange:r,onDateChange:c,onAddNote:m,onCopyAllNotes:f,onSelectAll:b,onClearAll:w,expanded:y,barWidth:_}=e;const v=y?188:52;return(0,l.jsx)(l.Fragment,{children:(0,l.jsxs)(p,{explorerWidth:v,barWidth:_,children:[(0,l.jsx)(g,{children:""===o.trim()?t.charAt(0).toUpperCase()+t.slice(1):"Search"}),"journal"===t&&(0,l.jsx)(u,{children:(0,l.jsx)("input",{title:"Select date",type:"date",value:n,onChange:c})}),(0,l.jsxs)(h,{children:[(0,l.jsx)("input",{placeholder:"Search",value:o,onChange:e=>r(e.target.value)}),(0,l.jsx)(a.K,{title:"Clear search",onClick:()=>r(""),children:(0,l.jsx)(s.rOP,{})})]}),(0,l.jsxs)(x,{children:[(0,l.jsx)(a.K,{title:"Clear all notes",onClick:w,children:(0,l.jsx)(d.TG1,{})}),(0,l.jsx)(a.K,{title:"Select all visible notes",onClick:b,children:(0,l.jsx)(d.NLe,{})}),(0,l.jsx)(a.K,{title:"Copy all visible notes",onClick:f,children:(0,l.jsx)(d.nxz,{})}),(0,l.jsx)(a.K,{title:"Add note",onClick:m,children:(0,l.jsx)(i.n4h,{})})]})]})})},p=r.Ay.div`
  display: flex;
...
`,x=r.Ay.div`
  ...
  align-items: center;
  height: 35px;
`;var m=n(2127);const f=e=>{try{JSON.parse(e)}catch(t){return!1}return!0},b=e=>{const t=e.split("-");return 3!==t.length?e:`${t[2]}/${t[1]}/${t[0]}`},w=e=>{if(!f(e))return[];const t=JSON.parse(e);return Array.from(new Set(t.tags||[]))},y=[{id:0,name:"Habits",title:"\ud83d\udd01 Habits - /year/S/eval(/month > 6 ? 2 : 1)",color:"#BBDEFB",tags:["daily"],text:String.raw`<div style="display:flex; gap:8px; align-items:flex-start;">
...
`,pe=r.Ay.div`
  position: relative;
  width: 100%;
`,ue=e=>{let{date:t,tags:n,availableTags:o,isLocked:r,tagPickerRef:a,showTagPicker:s,creatingTag:c,newTagName:p,setShowTagPicker:u,setCreatingTag:g,setNewTagName:h,hasTag:x,toggleTag:m,createTag:f,formatTag:b,formatDate:w}=e;return(0,l.jsxs)(ge,{children:[(0,l.jsxs)(xe,{children:[(0,l.jsx)(he,{children:w(t)}),n.map(e=>(0,l.jsx)(me,{onClick:()=>!r&&m(e),children:b(e)},e))]}),(0,l.jsxs)(fe,{ref:a,children:[!r&&(0,l.jsx)(be,{onClick:()=>u(!s),children:(0,l.jsx)(i.n4h,{})}),s&&(0,l.jsxs)(we,{children:[o.map(e=>(0,l.jsxs)(ye,{className:x(e)?"selected":"",onClick:()=>m(e),children:[(0,l.jsx)(d.cnX,{}),(0,l.jsx)("span",{children:b(e)})]},e)),c?(0,l.jsx)(ve,{autoFocus:!0,placeholder:"Tag name...",value:p,onChange:e=>h(e.target.value),onKeyDown:e=>{"Enter"===e.key&&f(p),"Escape"===e.key&&(g(!1),h(""))},onBlur:()=>{p.trim()?f(p):g(!1)}}):(0,l.jsxs)(_e,{onClick:()=>g(!0),children:[(0,l.jsx)(d.cnX,{}),"New Tag"]})]})]})]})},ge=r.Ay.div`
  display: flex;
  align-items: center;
  gap: 8px;
`,he=r.Ay.span`
...
`}}]);
//# sourceMappingURL=dashboard.eb4e8381.chunk.js.map