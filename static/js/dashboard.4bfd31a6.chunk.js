...
`,ke=r.Ay.div`
  position: relative;
  width: 100%;
`,je=e=>{let{date:t,tags:n,availableTags:r,isLocked:a,tagPickerRef:l,tagDropdownRef:c,showTagPicker:p,creatingTag:u,newTagName:g,setShowTagPicker:x,setCreatingTag:h,setNewTagName:m,onDateChange:f,hasTag:b,toggleTag:w,createTag:y,formatTag:v,formatDate:k}=e;const j=i.useRef(null);return(0,d.jsxs)(Ce,{children:[(0,d.jsxs)(Ae,{children:[(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(Se,{onClick:()=>{var e,t,n;null===(e=j.current)||void 0===e||null===(t=e.showPicker)||void 0===t||t.call(e),null===(n=j.current)||void 0===n||n.click()},children:k(t)}),(0,d.jsx)("input",{ref:j,type:"date",value:t,style:{display:"none"},onChange:e=>f(e.target.value)})]}),n.map(e=>(0,d.jsx)(Te,{onClick:()=>!a&&w(e),children:v(e)},e))]}),(0,d.jsxs)(De,{ref:l,children:[!a&&(0,d.jsx)(Me,{onClick:()=>x(!p),children:(0,d.jsx)(s.n4h,{})}),p&&(0,N.createPortal)((0,d.jsxs)(Ne,{ref:c,children:[r.map(e=>(0,d.jsxs)(Ee,{className:b(e)?"selected":"",onClick:()=>w(e),children:[(0,d.jsx)(o.cnX,{}),(0,d.jsx)("span",{children:v(e)})]},e)),u?(0,d.jsx)($e,{autoFocus:!0,placeholder:"Tag name...",value:g,onChange:e=>m(e.target.value),onKeyDown:e=>{"Enter"===e.key&&y(g),"Escape"===e.key&&(h(!1),m(""))},onBlur:()=>{g.trim()?y(g):h(!1)}}):(0,d.jsxs)(ze,{onClick:()=>h(!0),children:[(0,d.jsx)(o.cnX,{}),"New Tag"]})]}),document.body)]})]})},Ce=r.Ay.div`
  display: flex;
  align-items: flex-start;
...
`}}]);
//# sourceMappingURL=dashboard.4bfd31a6.chunk.js.map